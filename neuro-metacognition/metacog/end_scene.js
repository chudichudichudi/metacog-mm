...
metacog.EndScene.createScene = function (scale) {
  ...
  var label_thanks = new lime.Label().setPosition(0,0).setText("That's it, thank you!.").setFontSize(50).setFontWeight("bold");

  var label_try_again = new lime.Label().setPosition(0,250).setText("Return to TEDxperiments.").setFontSize(20).setFontWeight("bold");
  ...
  goog.events.listen(label_try_again, ['mousedown', 'touchstart'],function(e) {
    window.location = 'http://tedx.cloudapp.net';
  });
